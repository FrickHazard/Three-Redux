import { Group, Mesh, SphereGeometry, DirectionalLight, MeshPhongMaterial, MeshLambertMaterial, MeshBasicMaterial, WireframeGeometry } from 'three';
...
export class Level extends Group {
  ...
  constructor() {
    ...
    const test = new Mesh(new WireframeGeometry(buildChunk(
      {
        data: [
          [[3, 3, 3], [3, 3, 3], [3, 3, 3]],
          [[3, 3, 3], [3, 4, 3], [3, 3, 3]],
